package data_structure_avl;

import model.Player;
import data_structure_abb.BinarySearchTree;
import data_structure_abb.Node;

@SuppressWarnings("serial")
public class AvlTree<K extends Comparable<K>, T extends Player> extends BinarySearchTree<K, T> {
